...
export function TourDetailsModal({
  ...
  const getLocalizedContent = (
    ...
    const key =
      `${field}${currentLanguage.charAt(0).toUpperCase() + currentLanguage.slice(1)}` as keyof Tour;
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        ...
        data-testid="modal-tour-details"
      >
        <div className="relative">
          ...
          <div className="relative h-64 md:h-80 mb-6">
            ...
            {tour.imageUrls && tour.imageUrls.length > 1 && (
              <div className="absolute bottom-4 left-4 bg-black/50 text-white px-3 py-1 rounded-md">
                <span data-testid="text-image-counter">
                  1 / {tour.imageUrls.length}
                </span>
              </div>
            )}
          </div>
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-6">
            <div className="mb-4 md:mb-0">
              <DialogHeader>
                <DialogTitle
                  ...
                  data-testid="text-tour-modal-title"
                >
              ...
              <div className="flex items-center text-muted-foreground">
                ...
                <span data-testid="text-tour-modal-duration">
                  {tour.duration}
                </span>
            ...
            <div className="text-right">
              <div
                ...
                data-testid="text-tour-modal-price"
              >
                {formatPrice()}
              </div>
            </div>
          ...
          <div className="mb-6">
            ...
            <p
              ...
              data-testid="text-tour-modal-description"
            >
          ...
          <div className="mb-6">
            ...
            <ul
              className="grid grid-cols-1 md:grid-cols-2 gap-2 text-muted-foreground"
              data-testid="list-tour-highlights"
            >
              {(getLocalizedContent("highlights") as string[]).map(
                (highlight, index) => (
